...
const About = () => {
  ...
  return (
    <>
    <Header/>
    <section className='flex items-center justify-center text-white shadow-2xl border-2 border-zinc-900 rounded-md'>
    ...
    <img src={Czarny} alt='Photo Maniek' className=' m-2 p-2 rounded-lg'/>
    </section>
    <ContactForm/>
  </>
  );
